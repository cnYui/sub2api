...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	trafficPackRepository := repository.NewTrafficPackRepository(db, trafficCreditPolicy)
	...
	usageBillingRepository := repository.NewUsageBillingRepository(client, db, trafficCreditPolicy)
	...
	trafficCreditReservationRepository := repository.NewTrafficCreditReservationRepository(db, trafficCreditPolicy)
