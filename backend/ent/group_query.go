...
func (_q *GroupQuery) QuerySubscriptionEntitlementPeriods() *SubscriptionEntitlementPeriodQuery {
...
func (_q *GroupQuery) QuerySubscriptionQuotaDebtAdjustments() *SubscriptionQuotaDebtAdjustmentQuery {
...
func (_q *GroupQuery) WithSubscriptionEntitlementPeriods(opts ...func(*SubscriptionEntitlementPeriodQuery)) *GroupQuery {
	query := (&SubscriptionEntitlementPeriodClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *GroupQuery) WithSubscriptionQuotaDebtAdjustments(opts ...func(*SubscriptionQuotaDebtAdjustmentQuery)) *GroupQuery {
	query := (&SubscriptionQuotaDebtAdjustmentClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *GroupQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Group, error) {
	...
	if query := _q.withSubscriptionEntitlementPeriods; query != nil {
		if err := _q.loadSubscriptionEntitlementPeriods(ctx, query, nodes,
			func(n *Group) { n.Edges.SubscriptionEntitlementPeriods = []*SubscriptionEntitlementPeriod{} },
			func(n *Group, e *SubscriptionEntitlementPeriod) {
	...
	if query := _q.withSubscriptionQuotaDebtAdjustments; query != nil {
		if err := _q.loadSubscriptionQuotaDebtAdjustments(ctx, query, nodes,
			func(n *Group) { n.Edges.SubscriptionQuotaDebtAdjustments = []*SubscriptionQuotaDebtAdjustment{} },
			func(n *Group, e *SubscriptionQuotaDebtAdjustment) {
...
func (_q *GroupQuery) loadSubscriptionEntitlementPeriods(ctx context.Context, query *SubscriptionEntitlementPeriodQuery, nodes []*Group, init func(*Group), assign func(*Group, *SubscriptionEntitlementPeriod)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int64]*Group)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(subscriptionentitlementperiod.FieldGroupID)
	}
	query.Where(predicate.SubscriptionEntitlementPeriod(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(group.SubscriptionEntitlementPeriodsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *GroupQuery) loadSubscriptionQuotaDebtAdjustments(ctx context.Context, query *SubscriptionQuotaDebtAdjustmentQuery, nodes []*Group, init func(*Group), assign func(*Group, *SubscriptionQuotaDebtAdjustment)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int64]*Group)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(subscriptionquotadebtadjustment.FieldGroupID)
	}
	query.Where(predicate.SubscriptionQuotaDebtAdjustment(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(group.SubscriptionQuotaDebtAdjustmentsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
