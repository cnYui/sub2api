...
func (_c *GroupCreate) AddSubscriptionEntitlementPeriodIDs(ids ...int64) *GroupCreate {
...
func (_c *GroupCreate) AddSubscriptionEntitlementPeriods(v ...*SubscriptionEntitlementPeriod) *GroupCreate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *GroupCreate) AddSubscriptionQuotaDebtAdjustmentIDs(ids ...int64) *GroupCreate {
...
func (_c *GroupCreate) AddSubscriptionQuotaDebtAdjustments(v ...*SubscriptionQuotaDebtAdjustment) *GroupCreate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
