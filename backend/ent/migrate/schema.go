...
var (
	...
	BatchImageJobsColumns = []*schema.Column{
		...
		{Name: "balance_package_hold_usd", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
	...
	ChannelMonitorsColumns = []*schema.Column{
		...
		{Name: "api_mode", Type: field.TypeString, Size: 32, Default: "models"},
	...
	ChannelMonitorsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "channelmonitor_source_group_id_source_account_id",
				Unique:  false,
				Columns: []*schema.Column{ChannelMonitorsColumns[19], ChannelMonitorsColumns[20]},
			},
		},
	}
	...
	RedeemCodesTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "redeem_codes_balance_package_plans_redeem_codes",
				Columns:    []*schema.Column{RedeemCodesColumns[10]},
				RefColumns: []*schema.Column{BalancePackagePlansColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "redeemcode_balance_package_plan_id",
				Unique:  false,
				Columns: []*schema.Column{RedeemCodesColumns[10]},
			},
			{
	...
	UserBalancePackagesColumns = []*schema.Column{
		...
		{Name: "renewal_count", Type: field.TypeInt, Default: 0},
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				...
				Columns:    []*schema.Column{UserBalancePackagesColumns[15]},
				RefColumns: []*schema.Column{UsersColumns[0]},
				OnDelete:   schema.NoAction,
			},
		},
		Indexes: []*schema.Index{
			{
				...
				Unique:  false,
				Columns: []*schema.Column{UserBalancePackagesColumns[15], UserBalancePackagesColumns[12]},
			},
			{
				Name:    "userbalancepackage_status_next_credit_at",
				Unique:  false,
				Columns: []*schema.Column{UserBalancePackagesColumns[12], UserBalancePackagesColumns[10]},
			},
		},
	}
