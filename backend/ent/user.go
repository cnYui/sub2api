...
// BalancePackagesOrErr returns the BalancePackages value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) BalancePackagesOrErr() ([]*UserBalancePackage, error) {
	if e.loadedTypes[10] {
		return e.BalancePackages, nil
	}
