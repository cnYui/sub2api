...
func (tx *Tx) init() {
	...
	tx.BalancePackagePlan = NewBalancePackagePlanClient(tx.config)
	...
	tx.RedeemCard = NewRedeemCardClient(tx.config)
	tx.RedeemCode = NewRedeemCodeClient(tx.config)
	tx.ReimbursementRequest = NewReimbursementRequestClient(tx.config)
	...
	tx.UserBalancePackage = NewUserBalancePackageClient(tx.config)
