...
// The PaymentBalanceHoldFunc type is an adapter to allow the use of ordinary function as a Querier.
type PaymentBalanceHoldFunc func(context.Context, *ent.PaymentBalanceHoldQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f PaymentBalanceHoldFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.PaymentBalanceHoldQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.PaymentBalanceHoldQuery", q)
}

// The TraversePaymentBalanceHold type is an adapter to allow the use of ordinary function as Traverser.
type TraversePaymentBalanceHold func(context.Context, *ent.PaymentBalanceHoldQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraversePaymentBalanceHold) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraversePaymentBalanceHold) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.PaymentBalanceHoldQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.PaymentBalanceHoldQuery", q)
}
...
// The SubscriptionEntitlementPeriodFunc type is an adapter to allow the use of ordinary function as a Querier.
type SubscriptionEntitlementPeriodFunc func(context.Context, *ent.SubscriptionEntitlementPeriodQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f SubscriptionEntitlementPeriodFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.SubscriptionEntitlementPeriodQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.SubscriptionEntitlementPeriodQuery", q)
}

// The TraverseSubscriptionEntitlementPeriod type is an adapter to allow the use of ordinary function as Traverser.
type TraverseSubscriptionEntitlementPeriod func(context.Context, *ent.SubscriptionEntitlementPeriodQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseSubscriptionEntitlementPeriod) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseSubscriptionEntitlementPeriod) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.SubscriptionEntitlementPeriodQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.SubscriptionEntitlementPeriodQuery", q)
}
...
// The SubscriptionQuotaDebtAdjustmentFunc type is an adapter to allow the use of ordinary function as a Querier.
type SubscriptionQuotaDebtAdjustmentFunc func(context.Context, *ent.SubscriptionQuotaDebtAdjustmentQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f SubscriptionQuotaDebtAdjustmentFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.SubscriptionQuotaDebtAdjustmentQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.SubscriptionQuotaDebtAdjustmentQuery", q)
}

// The TraverseSubscriptionQuotaDebtAdjustment type is an adapter to allow the use of ordinary function as Traverser.
type TraverseSubscriptionQuotaDebtAdjustment func(context.Context, *ent.SubscriptionQuotaDebtAdjustmentQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseSubscriptionQuotaDebtAdjustment) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseSubscriptionQuotaDebtAdjustment) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.SubscriptionQuotaDebtAdjustmentQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.SubscriptionQuotaDebtAdjustmentQuery", q)
}
...
func NewQuery(q ent.Query) (Query, error) {
	...
	case *ent.PaymentBalanceHoldQuery:
		return &query[*ent.PaymentBalanceHoldQuery, predicate.PaymentBalanceHold, paymentbalancehold.OrderOption]{typ: ent.TypePaymentBalanceHold, tq: q}, nil
	...
	case *ent.SubscriptionEntitlementPeriodQuery:
		return &query[*ent.SubscriptionEntitlementPeriodQuery, predicate.SubscriptionEntitlementPeriod, subscriptionentitlementperiod.OrderOption]{typ: ent.TypeSubscriptionEntitlementPeriod, tq: q}, nil
	...
	case *ent.SubscriptionQuotaDebtAdjustmentQuery:
		return &query[*ent.SubscriptionQuotaDebtAdjustmentQuery, predicate.SubscriptionQuotaDebtAdjustment, subscriptionquotadebtadjustment.OrderOption]{typ: ent.TypeSubscriptionQuotaDebtAdjustment, tq: q}, nil
