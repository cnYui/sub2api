...
func (BatchImageJob) Fields() []ent.Field {
	return []ent.Field{
		...
		field.Int64("balance_package_id").Optional().Nillable(),
		field.Float("balance_package_hold_usd").SchemaType(map[string]string{dialect.Postgres: "decimal(20,10)"}).Default(0),
