...
// AddSubscriptionEntitlementPeriodIDs adds the "subscription_entitlement_periods" edge to the SubscriptionEntitlementPeriod entity by IDs.
func (_u *UserUpdate) AddSubscriptionEntitlementPeriodIDs(ids ...int64) *UserUpdate {
	_u.mutation.AddSubscriptionEntitlementPeriodIDs(ids...)
	return _u
}

// AddSubscriptionEntitlementPeriods adds the "subscription_entitlement_periods" edges to the SubscriptionEntitlementPeriod entity.
func (_u *UserUpdate) AddSubscriptionEntitlementPeriods(v ...*SubscriptionEntitlementPeriod) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *UserUpdate) AddSubscriptionQuotaDebtAdjustmentIDs(ids ...int64) *UserUpdate {
...
func (_u *UserUpdate) AddSubscriptionQuotaDebtAdjustments(v ...*SubscriptionQuotaDebtAdjustment) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddPaymentBalanceHoldIDs adds the "payment_balance_holds" edge to the PaymentBalanceHold entity by IDs.
func (_u *UserUpdate) AddPaymentBalanceHoldIDs(ids ...int64) *UserUpdate {
	_u.mutation.AddPaymentBalanceHoldIDs(ids...)
	return _u
}

// AddPaymentBalanceHolds adds the "payment_balance_holds" edges to the PaymentBalanceHold entity.
func (_u *UserUpdate) AddPaymentBalanceHolds(v ...*PaymentBalanceHold) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.AddPaymentBalanceHoldIDs(ids...)
}
...
// ClearSubscriptionEntitlementPeriods clears all "subscription_entitlement_periods" edges to the SubscriptionEntitlementPeriod entity.
func (_u *UserUpdate) ClearSubscriptionEntitlementPeriods() *UserUpdate {
	_u.mutation.ClearSubscriptionEntitlementPeriods()
	return _u
}

// RemoveSubscriptionEntitlementPeriodIDs removes the "subscription_entitlement_periods" edge to SubscriptionEntitlementPeriod entities by IDs.
func (_u *UserUpdate) RemoveSubscriptionEntitlementPeriodIDs(ids ...int64) *UserUpdate {
	_u.mutation.RemoveSubscriptionEntitlementPeriodIDs(ids...)
	return _u
}

// RemoveSubscriptionEntitlementPeriods removes "subscription_entitlement_periods" edges to SubscriptionEntitlementPeriod entities.
func (_u *UserUpdate) RemoveSubscriptionEntitlementPeriods(v ...*SubscriptionEntitlementPeriod) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *UserUpdate) ClearSubscriptionQuotaDebtAdjustments() *UserUpdate {
...
func (_u *UserUpdate) RemoveSubscriptionQuotaDebtAdjustmentIDs(ids ...int64) *UserUpdate {
...
func (_u *UserUpdate) RemoveSubscriptionQuotaDebtAdjustments(v ...*SubscriptionQuotaDebtAdjustment) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearPaymentBalanceHolds clears all "payment_balance_holds" edges to the PaymentBalanceHold entity.
func (_u *UserUpdate) ClearPaymentBalanceHolds() *UserUpdate {
	_u.mutation.ClearPaymentBalanceHolds()
	return _u
}

// RemovePaymentBalanceHoldIDs removes the "payment_balance_holds" edge to PaymentBalanceHold entities by IDs.
func (_u *UserUpdate) RemovePaymentBalanceHoldIDs(ids ...int64) *UserUpdate {
	_u.mutation.RemovePaymentBalanceHoldIDs(ids...)
	return _u
}

// RemovePaymentBalanceHolds removes "payment_balance_holds" edges to PaymentBalanceHold entities.
func (_u *UserUpdate) RemovePaymentBalanceHolds(v ...*PaymentBalanceHold) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.RemovePaymentBalanceHoldIDs(ids...)
}
...
func (_u *UserUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.SubscriptionEntitlementPeriodsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.SubscriptionEntitlementPeriodsTable,
			Columns: []string{user.SubscriptionEntitlementPeriodsColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
	...
	if nodes := _u.mutation.RemovedSubscriptionEntitlementPeriodsIDs(); len(nodes) > 0 && !_u.mutation.SubscriptionEntitlementPeriodsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.SubscriptionEntitlementPeriodsTable,
	...
	if nodes := _u.mutation.SubscriptionEntitlementPeriodsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.SubscriptionEntitlementPeriodsTable,
	...
	if _u.mutation.PaymentBalanceHoldsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.PaymentBalanceHoldsTable,
			Columns: []string{user.PaymentBalanceHoldsColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
	...
	if nodes := _u.mutation.RemovedPaymentBalanceHoldsIDs(); len(nodes) > 0 && !_u.mutation.PaymentBalanceHoldsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.PaymentBalanceHoldsTable,
	...
	if nodes := _u.mutation.PaymentBalanceHoldsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.PaymentBalanceHoldsTable,
...
// AddSubscriptionEntitlementPeriodIDs adds the "subscription_entitlement_periods" edge to the SubscriptionEntitlementPeriod entity by IDs.
func (_u *UserUpdateOne) AddSubscriptionEntitlementPeriodIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.AddSubscriptionEntitlementPeriodIDs(ids...)
	return _u
}

// AddSubscriptionEntitlementPeriods adds the "subscription_entitlement_periods" edges to the SubscriptionEntitlementPeriod entity.
func (_u *UserUpdateOne) AddSubscriptionEntitlementPeriods(v ...*SubscriptionEntitlementPeriod) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddSubscriptionQuotaDebtAdjustmentIDs adds the "subscription_quota_debt_adjustments" edge to the SubscriptionQuotaDebtAdjustment entity by IDs.
func (_u *UserUpdateOne) AddSubscriptionQuotaDebtAdjustmentIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.AddSubscriptionQuotaDebtAdjustmentIDs(ids...)
	return _u
}

// AddSubscriptionQuotaDebtAdjustments adds the "subscription_quota_debt_adjustments" edges to the SubscriptionQuotaDebtAdjustment entity.
func (_u *UserUpdateOne) AddSubscriptionQuotaDebtAdjustments(v ...*SubscriptionQuotaDebtAdjustment) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddPaymentBalanceHoldIDs adds the "payment_balance_holds" edge to the PaymentBalanceHold entity by IDs.
func (_u *UserUpdateOne) AddPaymentBalanceHoldIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.AddPaymentBalanceHoldIDs(ids...)
	return _u
}

// AddPaymentBalanceHolds adds the "payment_balance_holds" edges to the PaymentBalanceHold entity.
func (_u *UserUpdateOne) AddPaymentBalanceHolds(v ...*PaymentBalanceHold) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearSubscriptionEntitlementPeriods clears all "subscription_entitlement_periods" edges to the SubscriptionEntitlementPeriod entity.
func (_u *UserUpdateOne) ClearSubscriptionEntitlementPeriods() *UserUpdateOne {
	_u.mutation.ClearSubscriptionEntitlementPeriods()
	return _u
}

// RemoveSubscriptionEntitlementPeriodIDs removes the "subscription_entitlement_periods" edge to SubscriptionEntitlementPeriod entities by IDs.
func (_u *UserUpdateOne) RemoveSubscriptionEntitlementPeriodIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.RemoveSubscriptionEntitlementPeriodIDs(ids...)
	return _u
}

// RemoveSubscriptionEntitlementPeriods removes "subscription_entitlement_periods" edges to SubscriptionEntitlementPeriod entities.
func (_u *UserUpdateOne) RemoveSubscriptionEntitlementPeriods(v ...*SubscriptionEntitlementPeriod) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearSubscriptionQuotaDebtAdjustments clears all "subscription_quota_debt_adjustments" edges to the SubscriptionQuotaDebtAdjustment entity.
func (_u *UserUpdateOne) ClearSubscriptionQuotaDebtAdjustments() *UserUpdateOne {
	_u.mutation.ClearSubscriptionQuotaDebtAdjustments()
	return _u
}

// RemoveSubscriptionQuotaDebtAdjustmentIDs removes the "subscription_quota_debt_adjustments" edge to SubscriptionQuotaDebtAdjustment entities by IDs.
func (_u *UserUpdateOne) RemoveSubscriptionQuotaDebtAdjustmentIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.RemoveSubscriptionQuotaDebtAdjustmentIDs(ids...)
	return _u
}

// RemoveSubscriptionQuotaDebtAdjustments removes "subscription_quota_debt_adjustments" edges to SubscriptionQuotaDebtAdjustment entities.
func (_u *UserUpdateOne) RemoveSubscriptionQuotaDebtAdjustments(v ...*SubscriptionQuotaDebtAdjustment) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearPaymentBalanceHolds clears all "payment_balance_holds" edges to the PaymentBalanceHold entity.
func (_u *UserUpdateOne) ClearPaymentBalanceHolds() *UserUpdateOne {
	_u.mutation.ClearPaymentBalanceHolds()
	return _u
}

// RemovePaymentBalanceHoldIDs removes the "payment_balance_holds" edge to PaymentBalanceHold entities by IDs.
func (_u *UserUpdateOne) RemovePaymentBalanceHoldIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.RemovePaymentBalanceHoldIDs(ids...)
	return _u
}

// RemovePaymentBalanceHolds removes "payment_balance_holds" edges to PaymentBalanceHold entities.
func (_u *UserUpdateOne) RemovePaymentBalanceHolds(v ...*PaymentBalanceHold) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
