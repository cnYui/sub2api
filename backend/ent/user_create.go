...
func (_c *UserCreate) AddSubscriptionEntitlementPeriodIDs(ids ...int64) *UserCreate {
	_c.mutation.AddSubscriptionEntitlementPeriodIDs(ids...)
	return _c
}
...
func (_c *UserCreate) AddSubscriptionEntitlementPeriods(v ...*SubscriptionEntitlementPeriod) *UserCreate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *UserCreate) AddPaymentBalanceHoldIDs(ids ...int64) *UserCreate {
	_c.mutation.AddPaymentBalanceHoldIDs(ids...)
	return _c
}

// AddPaymentBalanceHolds adds the "payment_balance_holds" edges to the PaymentBalanceHold entity.
func (_c *UserCreate) AddPaymentBalanceHolds(v ...*PaymentBalanceHold) *UserCreate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddPaymentBalanceHoldIDs(ids...)
}
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.SubscriptionEntitlementPeriodsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := _c.mutation.PaymentBalanceHoldsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
