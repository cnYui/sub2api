...
const (
	...
	// EdgePaymentBalanceHolds holds the string denoting the payment_balance_holds edge name in mutations.
	EdgePaymentBalanceHolds = "payment_balance_holds"
	...
	// SubscriptionEntitlementPeriodsTable is the table that holds the subscription_entitlement_periods relation/edge.
	SubscriptionEntitlementPeriodsTable = "subscription_entitlement_periods"
	// SubscriptionEntitlementPeriodsInverseTable is the table name for the SubscriptionEntitlementPeriod entity.
	...
	// PaymentBalanceHoldsTable is the table that holds the payment_balance_holds relation/edge.
	PaymentBalanceHoldsTable = "payment_balance_holds"
	// PaymentBalanceHoldsInverseTable is the table name for the PaymentBalanceHold entity.
	// It exists in this package in order to avoid circular dependency with the "paymentbalancehold" package.
	PaymentBalanceHoldsInverseTable = "payment_balance_holds"
	// PaymentBalanceHoldsColumn is the table column denoting the payment_balance_holds relation/edge.
	PaymentBalanceHoldsColumn = "user_id"
...
// BySubscriptionEntitlementPeriodsCount orders the results by subscription_entitlement_periods count.
func BySubscriptionEntitlementPeriodsCount(opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborsCount(s, newSubscriptionEntitlementPeriodsStep(), opts...)
	}
}

// BySubscriptionEntitlementPeriods orders the results by subscription_entitlement_periods terms.
func BySubscriptionEntitlementPeriods(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newSubscriptionEntitlementPeriodsStep(), append([]sql.OrderTerm{term}, terms...)...)
	}
}
...
// ByPaymentBalanceHoldsCount orders the results by payment_balance_holds count.
func ByPaymentBalanceHoldsCount(opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborsCount(s, newPaymentBalanceHoldsStep(), opts...)
	}
}

// ByPaymentBalanceHolds orders the results by payment_balance_holds terms.
func ByPaymentBalanceHolds(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newPaymentBalanceHoldsStep(), append([]sql.OrderTerm{term}, terms...)...)
	}
}
...
func newSubscriptionEntitlementPeriodsStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
...
func newPaymentBalanceHoldsStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
		sqlgraph.To(PaymentBalanceHoldsInverseTable, FieldID),
		sqlgraph.Edge(sqlgraph.O2M, false, PaymentBalanceHoldsTable, PaymentBalanceHoldsColumn),
	)
}
