...
// HasSubscriptionEntitlementPeriods applies the HasEdge predicate on the "subscription_entitlement_periods" edge.
func HasSubscriptionEntitlementPeriods() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasSubscriptionEntitlementPeriodsWith applies the HasEdge predicate on the "subscription_entitlement_periods" edge with a given conditions (other predicates).
func HasSubscriptionEntitlementPeriodsWith(preds ...predicate.SubscriptionEntitlementPeriod) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newSubscriptionEntitlementPeriodsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
...
// HasSubscriptionQuotaDebtAdjustments applies the HasEdge predicate on the "subscription_quota_debt_adjustments" edge.
func HasSubscriptionQuotaDebtAdjustments() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasSubscriptionQuotaDebtAdjustmentsWith applies the HasEdge predicate on the "subscription_quota_debt_adjustments" edge with a given conditions (other predicates).
func HasSubscriptionQuotaDebtAdjustmentsWith(preds ...predicate.SubscriptionQuotaDebtAdjustment) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newSubscriptionQuotaDebtAdjustmentsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
...
// HasPaymentBalanceHolds applies the HasEdge predicate on the "payment_balance_holds" edge.
func HasPaymentBalanceHolds() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasPaymentBalanceHoldsWith applies the HasEdge predicate on the "payment_balance_holds" edge with a given conditions (other predicates).
func HasPaymentBalanceHoldsWith(preds ...predicate.PaymentBalanceHold) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newPaymentBalanceHoldsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
