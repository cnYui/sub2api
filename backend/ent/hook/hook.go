...
// The SubscriptionEntitlementPeriodFunc type is an adapter to allow the use of ordinary
// function as SubscriptionEntitlementPeriod mutator.
type SubscriptionEntitlementPeriodFunc func(context.Context, *ent.SubscriptionEntitlementPeriodMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f SubscriptionEntitlementPeriodFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.SubscriptionEntitlementPeriodMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.SubscriptionEntitlementPeriodMutation", m)
}
...
// The SubscriptionQuotaDebtAdjustmentFunc type is an adapter to allow the use of ordinary
// function as SubscriptionQuotaDebtAdjustment mutator.
type SubscriptionQuotaDebtAdjustmentFunc func(context.Context, *ent.SubscriptionQuotaDebtAdjustmentMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f SubscriptionQuotaDebtAdjustmentFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.SubscriptionQuotaDebtAdjustmentMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.SubscriptionQuotaDebtAdjustmentMutation", m)
}
