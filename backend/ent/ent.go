...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			balancepackageplan.Table:            balancepackageplan.ValidColumn,
			...
			redeemcard.Table:                    redeemcard.ValidColumn,
			redeemcode.Table:                    redeemcode.ValidColumn,
			reimbursementrequest.Table:          reimbursementrequest.ValidColumn,
			...
			userbalancepackage.Table:            userbalancepackage.ValidColumn,
