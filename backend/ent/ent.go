...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			paymentbalancehold.Table:              paymentbalancehold.ValidColumn,
			...
			subscriptionentitlementperiod.Table:   subscriptionentitlementperiod.ValidColumn,
			subscriptionplan.Table:                subscriptionplan.ValidColumn,
			subscriptionquotadebtadjustment.Table: subscriptionquotadebtadjustment.ValidColumn,
