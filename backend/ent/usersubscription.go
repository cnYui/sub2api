...
// EntitlementPeriodsOrErr returns the EntitlementPeriods value or an error if the edge
// was not loaded in eager-loading.
func (e UserSubscriptionEdges) EntitlementPeriodsOrErr() ([]*SubscriptionEntitlementPeriod, error) {
	if e.loadedTypes[4] {
		return e.EntitlementPeriods, nil
	}
...
// QueryEntitlementPeriods queries the "entitlement_periods" edge of the UserSubscription entity.
func (_m *UserSubscription) QueryEntitlementPeriods() *SubscriptionEntitlementPeriodQuery {
