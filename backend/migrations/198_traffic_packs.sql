...
CREATE INDEX IF NOT EXISTS idx_traffic_packs_for_sale_sort
    ON traffic_packs (for_sale, sort_order, id);
...
CREATE INDEX IF NOT EXISTS idx_traffic_credit_ledger_user_time
    ON traffic_credit_ledger (user_id, created_at DESC);

INSERT INTO traffic_packs (code, name, description, price, credit_usd, validity_days, platform, for_sale, sort_order)
VALUES
    ('gpt_traffic_5usd_2cny', 'GPT 流量包 5 刀', '2 元购买 5 USD GPT 额度，可用于 GPT 写代码和生图。', 2.00, 5.0000000000, 28, 'openai', TRUE, 10),
    ('gpt_traffic_10usd_3cny', 'GPT 流量包 10 刀', '3 元购买 10 USD GPT 额度，可用于 GPT 写代码和生图。', 3.00, 10.0000000000, 28, 'openai', TRUE, 20),
    ('gpt_traffic_20usd_5cny', 'GPT 流量包 20 刀', '5 元购买 20 USD GPT 额度，可用于 GPT 写代码和生图。', 5.00, 20.0000000000, 28, 'openai', TRUE, 30)
