...
const dashboardQuotaUsageFactsIndexMigration = "167_dashboard_quota_usage_facts_index_notx.sql"
const dashboardQuotaUsageFactsIndex = "idx_usage_facts_dashboard_user_completed"
...
var migrationChecksumCompatibilityRules = map[string]migrationChecksumCompatibilityRule{
	...
	"155_seed_codex_subscription_plans_baseline.sql":          newMigrationChecksumCompatibilityRule("64c22df919959e4afef129f8aacd2785254215cee2888f2ec162f65c36d1921f", "0e2d20c620783bf91cbf5ffb524edb46730e998a10799f66dd03e988a32b0b8f"),
	"156_seed_codex_79_subscription_plan.sql":                 newMigrationChecksumCompatibilityRule("35caceaf96260c67814cd35514271c21095f79bd708f60758d7104e56d0ea1b7", "bfd204584e5b768e03ebacd4ab6ba86562f3e73d5e6b9001807c0b1c53c10b49"),
}
...
func prepareNonTransactionalMigration(ctx context.Context, db *sql.DB, name string) error {
	...
	case dashboardQuotaUsageFactsIndexMigration:
		return dropInvalidIndexIfPresent(ctx, db, dashboardQuotaUsageFactsIndex)
	default:
		return nil
	}
}
