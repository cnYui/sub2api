...
const (
	...
	AffiliateRebateFreezeHoursDefault   = 24    // 0 = 不冻结
...
const (
	...
	RedeemTypeBalancePackage   = domain.RedeemTypeBalancePackage
...
const (
	...
	SettingKeyReimbursementLLMConfig           = "reimbursement_llm_config"            // 报销信息解析 LLM 配置（JSON，settings 优先于 env）
	...
	// 购买/到账成功通知
	SettingKeyPurchaseNotifyEnabled = "purchase_notify_enabled" // 余额套餐、流量卡、兑换码到账通知全局开关，默认开启
