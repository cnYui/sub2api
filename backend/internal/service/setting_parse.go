...
func (s *SettingService) InitializeDefaultSettings(ctx context.Context) error {
	...
	defaults := map[string]string{
		...
		SettingKeyAuthSourceDefaultOIDCConcurrency:          "20",
		...
		SettingKeyAuthSourceDefaultWeChatConcurrency:        "20",
		...
		SettingKeyAuthSourceDefaultGitHubConcurrency:        "20",
		...
		SettingKeyAuthSourceDefaultGoogleConcurrency:        "20",
		...
		SettingKeyAuthSourceDefaultDingTalkConcurrency:      "20",
		...
		// Channel monitor defaults (enabled, 30 minutes)
		SettingKeyChannelMonitorEnabled:                "true",
		SettingKeyChannelMonitorDefaultIntervalSeconds: "1800",
...
func (s *SettingService) parseSettings(settings map[string]string) *SystemSettings {
	...
	// Channel monitor feature (default: enabled, 30 minutes)
	...
	result.PurchaseNotifyEnabled = !isFalseSettingValue(settings[SettingKeyPurchaseNotifyEnabled])
