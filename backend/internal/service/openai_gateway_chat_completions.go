...
// ForwardAsChatCompletions accepts a Chat Completions request body, routes it
// to the best OpenAI-compatible upstream endpoint, and normalizes the response
// back to Chat Completions format when a protocol conversion is needed.
//
