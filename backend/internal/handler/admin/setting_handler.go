...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := systemSettingsToDTO(settings, paymentCfg, h.settingService.IsTotpEncryptionKeyConfigured(), opsEnabled)
...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	opsEnabled := h.opsService != nil && h.opsService.IsMonitoringEnabled(c.Request.Context())
	payload := systemSettingsToDTO(updatedSettings, updatedPaymentCfg, h.settingService.IsTotpEncryptionKeyConfigured(), opsEnabled)
	if fastPolicy, err := h.settingService.GetOpenAIFastPolicySettings(c.Request.Context()); err != nil {
		slog.Error("openai_fast_policy_settings_get_failed", "error", err)
	} else if fastPolicy != nil {
		payload.OpenAIFastPolicySettings = openaiFastPolicySettingsToDTO(fastPolicy)
