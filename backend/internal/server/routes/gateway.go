...
func RegisterGatewayRoutes(
	...
	gemini.Use(middleware.APIKeyAuthWithSubscriptionGoogleWithBillingCache(apiKeyService, subscriptionService, cfg, billingCacheService))
	...
	antigravityV1Beta.Use(middleware.APIKeyAuthWithSubscriptionGoogleWithBillingCache(apiKeyService, subscriptionService, cfg, billingCacheService))
