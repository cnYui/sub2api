  ...
  <div class="space-y-4">
          ...
          <div v-if="paidOrder" class="w-full rounded-xl bg-gray-50 p-4 dark:bg-dark-800">
            <div class="space-y-2 text-sm">
              ...
              <div class="flex justify-between">
                ...
                <span class="font-medium text-gray-900 dark:text-white">{{ formatGatewayAmount(paidOrder.amount, paidOrder.currency) }}</span>
              </div>
              <div class="flex justify-between">
    ...
    <template v-else-if="isMobileAlipayDeepLink">
      <template v-if="!deepLinkFallbackVisible">
        ...
        <div class="purchase-panel p-4 text-center">
      ...
      <template v-else>
        <div data-test="alipay-qr-fallback" class="purchase-panel p-6">
...
const showQRCode = computed(() =>
  (!!qrUrl.value || !!qrImageUrl.value) && (!isMobileAlipayDeepLink.value || deepLinkFallbackVisible.value),
)
