  ...
  <div class="rounded-lg border border-gray-200 dark:border-dark-600">
      ...
      <div class="flex items-center justify-between p-4" :class="{ 'pb-0': localEnabled && !collapsed }">
        ...
        <button
          ...
          :class="[
            'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-gray-900/20 focus:ring-offset-2 dark:focus:ring-gray-100/30 dark:focus:ring-offset-dark-800',
            localEnabled ? 'bg-gray-900 dark:bg-gray-100' : 'bg-gray-200 dark:bg-dark-600'
          ]"
        >
          <span
            :class="[
