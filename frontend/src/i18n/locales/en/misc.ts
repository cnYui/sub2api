export default {
  ...
  userSubscriptions: {
    ...
    balancePackagesDesc: 'Your purchased 29, 39, 49, 299 and other balance packages with credit progress.',
    balancePackageValidity: '{days} days valid',
    weeklyCredit: 'Weekly credit',
    weeklyRemaining: "This week's remaining credit",
    creditedProgress: 'Credit progress',
    balancePackageProgress: 'Package progress',
    nextCredit: 'Next credit',
    nextRefresh: 'Next refresh',
    refreshCompleted: 'This billing period is complete. No further refreshes.',
    earlyRefresh: 'Refresh early',
    earlyRefreshTitle: 'Refresh the next period early',
    earlyRefreshMessage: 'Period {next} of {total} (${amount}) will be credited now, and the next automatic refresh moves one interval later. The package expiry date is unchanged.',
    earlyRefreshNote: 'The package still totals {total} periods — refreshing early only moves a later period to now, it neither adds nor removes credit.',
    earlyRefreshConfirm: 'Refresh now',
    earlyRefreshBlockedQuota: 'You still have ${amount} left this period. Use it up to refresh the next one early.',
    earlyRefreshSuccess: 'Credited period {count} of {total} (${amount})',
    earlyRefreshFailed: 'Could not refresh early. Please try again later.',
    buyAgain: 'Buy again',
  ...
  payment: {
    ...
    orders: {
      ...
      trafficCredit: 'Traffic credit',
      types: {
        balance: 'Balance top-up',
        subscription: 'Subscription',
        balance_subscription: 'Balance package',
        traffic_pack: 'Traffic card',
      },
      actions: 'Actions',
    ...
    refundQuote: {
      purchaseBase: 'Purchase amount',
      nonRefundableFee: 'Non-refundable fee',
      periodQuotaUsage: 'Period quota used',
      retainedQuota: 'Incl. quota kept in balance at cancellation',
      reclaimQuota: 'Deducted from balance after refund',
      reclaimNotice: "After the refund succeeds, this week's unused {amount} of quota will be deducted from your balance.",
      usageRatio: 'Quota usage ratio',
      timeRatio: 'Time usage ratio',
    ...
    errors: {
      ...
      REFUND_FAILED: 'Refund failed.',
      BALANCE_PACKAGE_ACTIVE: 'You already have an active balance package. Refund it before buying a different package.',
    },
    ...
    admin: {
      ...
      balancePackageOrder: 'Balance Package',
      trafficPackOrder: 'Traffic card',
      paidAt: 'Paid At',
      ...
      lastAttemptedRefund: 'Last attempted refund',
      refundQuoteLive: 'Calculated from the current time and usage. The server recalculates on confirm, so the final amount may be slightly lower.',
      refundQuoteFailed: 'Unable to calculate the refund amount, so this order cannot be refunded right now.',
      refundReclaimNotice: "After the refund succeeds, this week's unused {amount} of quota will be deducted from the user's balance.",
      ...
      cancelBalancePackage: 'Cancel Package',
      cancelBalancePackageConfirm: 'Cancel the balance package entitlement for order #{id}? This stops future credits and lets the user buy again. It does not issue a refund or change the order status.',
      confirmCancelBalancePackage: 'Cancel Package',
      balancePackageCancelled: 'Balance package cancelled',
      retry: 'Retry',
