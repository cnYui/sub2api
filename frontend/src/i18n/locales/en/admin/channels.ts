export default {
    ...
    channelMonitor: {
      ...
      syncGroups: 'Sync from groups',
      syncGroupsHint: "Generate monitors from enabled groups and account model whitelists, probing /v1/models with each account's upstream URL and key. Also runs automatically every 10 minutes.",
      syncGroupsSuccess: 'Synced: {created} created, {updated} updated, {disabled} disabled, {unchanged} unchanged',
      syncGroupsSkipped: '{n} account(s) produced no monitor: {detail}',
      syncGroupsFailed: 'Failed to sync from groups',
      groupSyncedBadge: 'Group sync',
      groupSyncedTooltip: 'Maintained by group sync (group #{group}, account #{account}). Name, URL, key and models are overwritten on the next sync from the group and account whitelist; the primary model is kept while it stays whitelisted.',
      groupSyncedEditNotice: 'This monitor is maintained by group sync: name, upstream URL, key, model list and enabled state are overwritten on the next sync. Change the account whitelist to change models; only primary model, interval and jitter edits are kept here.',
      ...
      form: {
        ...
        provider: 'Platform',
        apiMode: 'Monitor mode',
        apiModeModels: 'Models catalog probe (GET /v1/models)',
        apiModeModelsHint: 'Checks authentication, HTTP 2xx, and model presence without sending an inference request or consuming inference tokens.',
    ...
    subscriptions: {
      ...
      selectBalancePackage: 'Select a balance package',
      groupHint: 'Only groups with subscription billing type are shown',
      balancePackageHint: 'Only packages currently available on the purchase page are shown. The first credit is applied immediately.',
      ...
      grant: 'Grant',
      granting: 'Granting...',
      grantBalancePackage: 'Grant Package',
      adjust: 'Adjust',
      adjusting: 'Adjusting...',
      revoke: 'Revoke',
      restore: 'Restore',
      ...
      balancePackageGranted: 'Balance package granted successfully',
      ...
      failedToGrantBalancePackage: 'Failed to grant balance package',
      ...
      pleaseSelectBalancePackage: 'Please select a balance package',
