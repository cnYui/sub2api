    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          description: 'Existing users invite new ones; the inviter receives a percentage rebate directly in their balance. Enabled by default.',
          enabled: 'Enable Affiliate',
          enabledHint: 'When off, the affiliate menu is hidden, the aff parameter is ignored at signup, and new recharges generate no rebate.',
          ...
          freezeHoursDesc: 'New rebates remain usable for model charges during this freeze period. The default is 24 hours. 0 = no freeze.',
