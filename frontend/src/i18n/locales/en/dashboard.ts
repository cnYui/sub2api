export default {
  ...
  monitorCommon: {
    ...
    modelCatalogLatency: 'Model Catalog Latency',
  ...
  redeem: {
    ...
    codeRule2:
      'Codes may add balance, activate a balance package, increase concurrency, or grant trial access',
    ...
    balancePackageRedeemed: 'Balance Package Activated',
    balancePackageAddedRedeem: 'Balance Package (Redeem)',
    balancePackageDetail: '${credit} per refresh, {count} refreshes, valid for {days} days',
    days: ' days',
