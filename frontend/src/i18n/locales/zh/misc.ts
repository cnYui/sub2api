export default {
  ...
  userSubscriptions: {
    ...
    balancePackagesDesc: '展示购买页已购买的 29、39、49、299 等套餐及其到账进度。',
    balancePackageValidity: '{days} 天有效',
    weeklyCredit: '每周到账',
    weeklyRemaining: '本周剩余额度',
    creditedProgress: '到账进度',
    balancePackageProgress: '套餐周期进度',
    nextCredit: '下次到账',
    nextRefresh: '下次刷新',
  ...
  payment: {
    ...
    orders: {
      ...
      types: {
        balance: '余额充值',
        subscription: '订阅',
        balance_subscription: '余额套餐',
        traffic_pack: 'GPT 流量卡',
      },
      actions: '操作',
      requestRefund: '申请退款',
      retryRefund: '重试退款',
    ...
    refundQuote: {
      purchaseBase: '购买金额',
      nonRefundableFee: '不可退手续费',
      periodQuotaUsage: '周期额度使用',
      usageRatio: '额度使用比例',
      timeRatio: '时间使用比例',
    ...
    errors: {
      ...
      REFUND_FAILED: '退款失败',
      BALANCE_PACKAGE_ACTIVE: '当前已有有效余额套餐，请先退款后再购买其他套餐',
    },
    ...
    admin: {
      ...
      balancePackageOrder: '余额套餐',
      trafficPackOrder: 'GPT 流量卡',
      paidAt: '支付时间',
      completedAt: '完成时间',
      expiresAt: '过期时间',
      feeRate: '手续费率',
      ...
      cancelBalancePackage: '取消套餐',
      cancelBalancePackageConfirm: '确定取消订单 #{id} 的余额套餐权益吗？此操作会停止后续到账并允许用户重新购买，不会发起退款或修改订单状态。',
      confirmCancelBalancePackage: '确认取消套餐',
      balancePackageCancelled: '余额套餐已取消',
      retry: '重试',
      retrySuccess: '重试成功',
      approveRefund: '批准退款',
      retryRefund: '重试退款',
