export default {
  ...
  redeem: {
    ...
    codeRule2: '兑换码可以增加余额、开通余额套餐、增加并发数或试用权限',
    ...
    balancePackageRedeemed: '余额套餐已开通',
    balancePackageAddedRedeem: '余额套餐（兑换）',
    balancePackageDetail: '每期 ${credit}，共 {count} 期，有效期 {days} 天',
    days: '天',
