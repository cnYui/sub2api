export default {
  ...
  payment: {
    ...
    errors: {
      ...
      ACTIVE_SUBSCRIPTION_EXISTS: 'You can only renew your current plan. Before buying a new plan, request a prorated refund in My Orders.',
      ACTIVE_SUBSCRIPTION_SWITCH_REQUIRES_REFUND: 'You can only renew your current plan. Before buying a new plan, request a prorated refund in My Orders.',
