<template>
  <div
    class="flex min-h-screen items-center justify-center bg-[#fafafa] p-4 text-gray-900 dark:bg-dark-950 dark:text-gray-100"
  >
    <div class="w-full max-w-2xl">
      ...
      <div class="mb-8 text-center">
        ...
        >
          <Icon name="cog" size="xl" class="text-current" />
        </div>
        ...
        <div class="flex items-center justify-center">
          <template v-for="(step, index) in steps" :key="step.id">
              ...
              <div
                :class="[
                  ...
                  currentStep > index
                    ...
                    : currentStep === index
                      ? 'bg-gray-900 text-white ring-4 ring-gray-200 dark:bg-gray-100 dark:text-dark-950 dark:ring-dark-700'
            ...
            <div
              ...
              :class="currentStep > index ? 'bg-gray-900 dark:bg-gray-100' : 'bg-gray-200 dark:bg-dark-700'"
            ></div>
          </template>
        </div>
      </div>
      ...
      <div class="rounded-lg border border-gray-200 bg-white p-8 shadow-soft dark:border-dark-700 dark:bg-dark-900 dark:shadow-soft-dark">
        ...
        <div v-if="currentStep === 0" class="space-y-6">
          ...
          >
            ...
            <Icon v-else-if="dbConnected" name="check" size="md" class="mr-2 text-gray-600 dark:text-gray-300" :stroke-width="2" />
            {{
              testingDb
        ...
        >
          <div class="flex items-start gap-3">
            <svg
              v-if="!serviceReady"
              class="h-5 w-5 flex-shrink-0 animate-spin text-gray-600 dark:text-gray-300"
              fill="none"
              viewBox="0 0 24 24"
            >
              <circle
            ...
            <Icon v-else name="checkCircle" size="md" class="flex-shrink-0 text-gray-600 dark:text-gray-300" />
            <div>
