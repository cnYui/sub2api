...
describe('HomeView', () => {
  ...
  it('中文首页文案展示 28 天订阅、周额度和刷新规则', () => {
    ...
    expect(source).toContain('28 天订阅，每 7 天刷新，周额度 58 刀')
    expect(source).toContain("multiAccount: '39 元套餐'")
    expect(source).toContain('28 天订阅，每 7 天刷新，周额度 78 刀')
    expect(source).toContain("balanceQuota: '59 元套餐'")
    expect(source).toContain('28 天订阅，每 7 天刷新，周额度 118 刀')
    expect(source).toContain("premiumQuota: '99 元套餐'")
    expect(source).toContain('28 天订阅，每 7 天刷新，周额度 198 刀')
