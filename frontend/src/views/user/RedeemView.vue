    ...
    <div class="mx-auto max-w-2xl space-y-6">
      ...
      <div class="card overflow-hidden">
        <div class="bg-gray-900 px-6 py-8 text-center text-white dark:bg-gray-100 dark:text-dark-950">
          <div
            class="mb-4 inline-flex h-16 w-16 items-center justify-center rounded-md border border-white/20 bg-white/10 dark:border-dark-300 dark:bg-dark-950/10"
          >
            <Icon name="creditCard" size="xl" class="text-current" />
          </div>
          <p class="text-sm font-medium text-gray-200 dark:text-dark-700">{{ t('redeem.currentBalance') }}</p>
          <p class="mt-2 text-4xl font-bold">
            ${{ user?.balance?.toFixed(2) || '0.00' }}
          </p>
          <p class="mt-2 text-sm text-gray-200 dark:text-dark-700">
      ...
      <transition name="fade">
        <div
          v-if="redeemResult"
          class="card border-gray-300 bg-gray-50 dark:border-dark-700 dark:bg-dark-900"
        >
          <div class="p-6">
            <div class="flex items-start gap-4">
              <div
                class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-md bg-gray-200 dark:bg-dark-700"
              >
        ...
        <div class="p-6">
          <div class="flex items-start gap-4">
            ...
            <div class="flex-1">
              ...
              <ul
                class="mt-2 list-inside list-disc space-y-1 text-sm text-gray-700 dark:text-gray-300"
              >
                ...
                <li>
                  ...
                  <span
                    v-if="contactInfo"
                    class="ml-1.5 inline-flex items-center rounded-md bg-gray-200 px-2 py-0.5 text-xs font-medium text-gray-800 dark:bg-dark-700 dark:text-gray-200"
                  >
                    {{ contactInfo }}
                  </span>
                </li>
              ...
              <div class="text-right">
                <p
                  :class="[
                    ...
                    item.value >= 0 || isSubscriptionType(item.type)
