...
- 将 `17371571728@phone.com` 对应的 Sub2API 用户改为真实邮箱 `2246950894@qq.com`。
...
- 目标用户存在：
  - `users.id=15`
  - `users.email=17371571728@phone.com`
  - `users.username=17371571728@phone.com`
  - `role=user`
  - `status=active`
...
- 用户存在一条 `auth_identities` email 身份：
  - `provider_type=email`
  - `provider_key=email`
  - `provider_subject=17371571728@phone.com`
