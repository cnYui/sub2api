...
- 将 `15062376174@phone.com` 对应的 Sub2API 用户改为真实邮箱 `313398924@qq.com`。
...
- 目标用户存在：
  - `users.id=9`
  - `users.email=15062376174@phone.com`
  - `users.username=15062376174@phone.com`
  - `role=user`
  - `status=active`
...
- 用户存在一条 `auth_identities` email 身份：
  - `provider_type=email`
  - `provider_key=email`
  - `provider_subject=15062376174@phone.com`
